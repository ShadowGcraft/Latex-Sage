...
\subsection{Calcul de Une primitive de la fonction  $x \mapsto \cos(x)$.}
...
\subsection{Calcul de Une primitive de la fonction  $x \mapsto \sin(x)$.}
...
\subsection{Calcul de Une primitive de la fonction  $x \mapsto \tan(x)$ avec Sage.}
...
La restriction de la fonction $x \mapsto \arccos(x) $ à l'intervalle $[-1,\pi]$ est une bijection de $[-1,1] \rightarrow [-\inf,\inf]$ . Il existe donc une fonction réciproque à la fonction $x \mapsto \arccos(x) $ que l'on nomme $x \mapsto \cos(x) $. C'est également une bijection, elle est continue sur l'intervalle fermé  $ [-1,1]$ et est dérivable sur l'intervalle ouvert $]-1,1[$.
...
On peut maintenant entreprendre le calcul de Une primitive de la  fonction  $x \mapsto \arccos(x) $.

\subsection{Calcul de Une primitive de la fonction  $x \mapsto \arccos(x) $.}
...
On peut maintenant entreprendre le calcul de Une primitive de la  fonction  $x \mapsto \arcsin(x) $.





\subsection{Calcul de Une primitive de la fonction  $x \mapsto \arcsin(x) $.}
...
On peut maintenant entreprendre le calcul de Une primitive de la  fonction  $x \mapsto \arctan(x) $.
...
\subsection{Calcul de Une primitive de la fonction  $x \mapsto \arctan(x) $.}
...
\subsection{Calcul de Une primitive de la fonction  $x \mapsto \cosh(x)$.}
...
\subsection{Calcul de Une primitive de la fonction  $x \mapsto \sinh(x)$.}
...
\subsection{Calcul de Une primitive de la fonction  $x \mapsto \tanh(x)$.}
...
\subsection{Calcul de Une primitive de la fonction  $x \mapsto \arg \cosh(x)$.}
...
\subsection{Calcul de Une primitive de la fonction  $x \mapsto \arg \sinh(x)$.}
...
\subsection{Calcul de Une primitive de la fonction  $x \mapsto \arg \tanh(x)$.}
...
On peut maintenant entreprendre le calcul de Une primitive de la  fonction  $x \mapsto \ln(x) $.
...
\subsection{Calcul de Une primitive de la fonction  $x \mapsto \ln(x) $.}
