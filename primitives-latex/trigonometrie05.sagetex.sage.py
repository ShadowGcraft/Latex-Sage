...
try:
 ...
 _st_.plot(_sage_const_24 , format='notprovided', _p_=plot(x+sqrt(x**_sage_const_2 +_sage_const_1 ), x, -_sage_const_5 , _sage_const_5 ))
except:
 _st_.goboom(_sage_const_1019 )
try:
 _st_.current_tex_line = _sage_const_1020 
 _st_.plot(_sage_const_25 , format='notprovided', _p_=plot(diff(x+sqrt(x**_sage_const_2 +_sage_const_1 ),x), x, -_sage_const_5 , _sage_const_5 ))
except:
 _st_.goboom(_sage_const_1020 )
try:
 _st_.current_tex_line = _sage_const_1053 
 _st_.plot(_sage_const_26 , format='notprovided', _p_=plot(log(x+sqrt(x**_sage_const_2 +_sage_const_1 )), x, -_sage_const_5 , _sage_const_5 ))
except:
 _st_.goboom(_sage_const_1053 )
try:
 _st_.current_tex_line = _sage_const_1055 
 _st_.plot(_sage_const_27 , format='notprovided', _p_=plot(arcsinh(x), x, -_sage_const_5 , _sage_const_5 ))
except:
